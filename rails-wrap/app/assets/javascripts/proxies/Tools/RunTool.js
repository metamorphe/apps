...
RunTool.SHORT_MESSAGE = "You are shorting your circuit. Avoid crossing any paths or connecting to terminals that aren't the same color (polarity).";

function RunTool(paper){
	this.paper = paper;
...
RunTool.getAllIntersections = function(path, wires){
...
RunTool.getAllInsides = function(path, wires){
		intersections = _.reduce(wires, function(memo, el){
